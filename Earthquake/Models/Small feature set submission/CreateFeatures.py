...
# calculate a slew of stats and let the
# model sort out which ones are useful
...
####################################################################
# set a few constants grabbed from the data.describe()
#####################################################################
...
# if you don't copy everything points to one array and 
# the separate changes hold true for all
...
# many will turn out to be worthless, this is just a first pass
##########################################################################################
...
#################################################################################################
# the large training file was split into chunks the same size at the test data
# this turned out to be time consuming, better to feed the train file through in sections
# and calculate the stats on the fly
#################################################################################################
...
#######################################################################################################
# calculate the same stats on the test files
#########################################################################################################
